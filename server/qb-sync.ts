...
export async function runFullSync(): Promise<{
  ...
  try {
    ...
    // 3. Sync payments (updates order statuses)
    ...
    await updateSyncLog(logId, {
      ...
      ordersCreated: invResult.created,
      ordersUpdated: invResult.updated,
    ...
    console.log(
      `[QB Sync] Complete: ${custResult.created} customers created, ${custResult.updated} updated, ${invResult.created} invoices created, ${invResult.updated} updated, ${pmtResult.processed} payments processed`
    );
